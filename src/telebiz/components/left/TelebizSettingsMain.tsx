    ...
    <div className="settings-fab-wrapper">
      ...
      <div className="settings-main-menu pr-2">
        ...
        <ListItem
          ...
          narrow
          buttonClassName={styles.customIconButton}
          onClick={() => openTelebizSettingsScreen({ screen: TelebizSettingsScreens.Notifications })}
        >
          {lang('Settings.Menu.Notifications')}
          {notificationsUnreadCount > 0 && (
            <span className={styles.badge}>{notificationsUnreadCount}</span>
          )}
        </ListItem>
      </div>
      <div className="settings-main-menu pr-2">
...
export default memo(withGlobal<OwnProps>(
  (global): Complete<StateProps> => {
    ...
    return {
      integrationsCount,
      notificationsUnreadCount: selectTelebizNotificationsUnreadCount(global),
    };
  },
)(TelebizSettingsMain));
